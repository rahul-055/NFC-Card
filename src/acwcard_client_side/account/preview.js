...
import { AiFillCamera, AiOutlinePhone, AiOutlinePlus, AiOutlineSetting } from 'react-icons/ai';
...
import { Capitalize, Imagevalidation, Urlvalidate } from '../../common/validate';
...
class Preview extends Component {
    ...
    componentDidMount() {
        document.title = 'ACW CARD - Preview'
    ...
    vCard = () => {
        ...
        axios.post(ImportedURL.API.vCardGenerateOwner, formData)
            .then((res) => {
                this.setState({ updateSpinner: false })
                if (res.data) {
                    let vcardData = res.data.vcard
                    var url = 'data:text/x-vcard;charset=utf-8,' + encodeURIComponent(vcardData);
                            ...
                            <Col xs="12" lg="5" md="12" sm="12">
                                <div className='acw_card_nav_images'>
                                    ...
                                    <div className='acw_card_setting'>
                                        <p className=''>
                                            <Link to="/accountsetting" onClick={(e) => this.props.HandleChangesSetting('preview')}>
                                                <AiOutlineSetting />
                                            </Link>
                                        </p>
                                    </div>
...
// const file = new Blob([vcardData], { type: "text/plain;charset=utf-8" });
