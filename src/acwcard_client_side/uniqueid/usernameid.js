...
class UsernameId extends Component {
    constructor(props) {
        super(props);
        this.state = {
            updateSpinner: false,
                                                                                ...
                                                                                <div className='social_media_text'>
                                                                                    <div>
                                                                                        ...
                                                                                        } */}
                                                                                        {
                                                                                            ...
                                                                                            <>
                                                                                                <p className='link_over_flow'>
                                                                                                    <a href={"tel:" + item.value} target="_blank" style={{ color: 'black', textDecoration: 'none' }}>
                                                                                                        {item.value}
                                                                                                    </a>
                                                                                                </p>
                                                                                            </>
...
export default connect(mapStateToProps, mapDispatchToProps)(UsernameId);